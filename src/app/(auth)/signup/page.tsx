      ...
      <div className="bg-[#12121a] rounded-lg border border-[#1e1e2e] p-8 shadow-2xl">
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          {plans.map((plan) => (
            ...
            >
              {plan.popular && (
                <div className="absolute -top-2 left-3 bg-[#FF9F43] text-white text-[9px] font-bold px-2 py-0.5 rounded-full">
                  POPULAR
                </div>
              )}
            ...
            <div className="grid grid-cols-2 gap-2">
              {selectedPlanData.features.map((feature, idx) => (
                <div key={idx} className="flex items-center gap-2">
                  <Check size={14} className="text-[#FF9F43] flex-shrink-0" />
        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-2 rounded bg-[#0a0a0f] border border-[#1e1e2e] text-[#e8e8f0] placeholder-[#8888a0] focus:outline-none focus:border-[#FF9F43] transition"
              />
            </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full px-4 py-3 rounded-lg font-semibold text-white bg-[#FF9F43] hover:bg-[#5558d9] disabled:opacity-50 disabled:cursor-not-allowed transition"
          >
        ...
        <div className="mt-5 text-center text-sm">
          ...
          <Link
            href="/login"
            className="text-[#FF9F43] hover:text-[#7c7fe5] font-medium transition"
          >
            Sign In
          </Link>
        </div>
